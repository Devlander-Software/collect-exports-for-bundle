...
exports.autoExporter = exports.fileHasValidExtension = exports.generateExportsFromDir = exports.createTestFolderAndFiles = void 0;
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const pc = __importStar(require("picocolors"));
const createTestFolderAndFiles = (folderPath, files) => {
    fs.mkdirSync(folderPath, { recursive: true });
    for (const file of files) {
        fs.writeFileSync(path.join(folderPath, file), '');
    }
};
exports.createTestFolderAndFiles = createTestFolderAndFiles;
